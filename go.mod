...
require (
	...
	github.com/stellar/go v0.0.0-20240307232833-ab3a9265a31d
...
replace github.com/decentrio/converter => github.com/decentrio/xdr-converter v0.0.0-20240410063401-4fc753ccd7aa
